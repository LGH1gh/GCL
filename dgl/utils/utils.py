...
def build_lr_scheduler(optimizer: Optimizer, data_info, init_lr, max_lr, final_lr, args: Namespace, total_epochs: List[int] = None) -> _LRScheduler:
    return NoamLR(
        optimizer=optimizer,
        warmup_epochs=[args.warmup_epochs],
        total_epochs=total_epochs or [args.epoch_num] * args.lr_num,
        steps_per_epoch=data_info['train_steps_per_epoch'],
        init_lr=[init_lr],
        max_lr=[max_lr],
        final_lr=[final_lr]
    )
